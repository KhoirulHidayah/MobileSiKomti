            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: [
                  ...
                  DropdownMenuItem(value: '2', child: Text('Keterampilan Komunikasi')),
                  ...
                  DropdownMenuItem(value: '6', child: Text('Analisis dan Desain Sistem')),
                  ...
                  DropdownMenuItem(value: '10', child: Text('Manajemen Database')),
                ],
                onChanged: (value) {
                  setState(() {
