...
class _ProfileScreenState extends State<ProfileScreen> {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            IconButton(
              icon: const Icon(Icons.arrow_back, color: Colors.white), // Menyesuaikan warna ikon dengan teks
              onPressed: () {
            ...
            const Text(
              ...
              style: TextStyle(
                fontSize: 20,
                fontWeight: FontWeight.bold,
                color: Colors.white, // Menyesuaikan warna teks agar kontras dengan latar belakang biru
                fontFamily: 'Montserrat',
              ),
            ),
          ],
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor:
          const Color.fromARGB(255, 255, 255, 255), // Set background color of the scaffold
      body: SafeArea(
